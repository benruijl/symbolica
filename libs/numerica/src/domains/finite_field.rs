...
impl<UField: FiniteFieldWorkspace> FiniteFieldElement<UField> {
    /// Get the internal representation of the element.
    /// The meaning of the representation depends on the specific field implementation.
    pub fn get_representation(&self) -> &UField {
        &self.0
    }

    /// Create a new element from its internal representation.
    /// The meaning of the representation depends on the specific field implementation.
    pub fn from_representation(rep: UField) -> Self {
        FiniteFieldElement(rep)
    }
}
