...
pub struct GenerationSettings<N, E> {
    filter_fn: Option<Box<dyn Fn(&Graph<N, E>, usize) -> bool>>,
...
impl<N, E> GenerationSettings<N, E> {
    ...
    pub fn filter_fn(mut self, filter_fn: Box<dyn Fn(&Graph<N, E>, usize) -> bool>) -> Self {
    ...
    /// are returned.
    pub fn abort_check(mut self, abort_check: Box<dyn Fn() -> bool>) -> Self {
