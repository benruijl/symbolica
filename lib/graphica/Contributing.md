# Contributing to Graphica

Graphica is open to contributions from the community, which can be submitted via a Pull Request (PR) on Github. Before you submit your PR, consider the following guidelines:
...
## Graphica Individual Contributor License Agreement
