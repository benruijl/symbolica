...
fn main() {
    let mut a = MultivariatePolynomial::<_, u8>::new(3, &Q, Some(3), None);
    ...
    let mut b = MultivariatePolynomial::<_, u8>::new(3, &Q, Some(3), None);
    ...
    let mut a = MultivariatePolynomial::<_, u8>::new(3, &finite_field, Some(3), None);
    ...
    let mut b = MultivariatePolynomial::<_, u8>::new(3, &finite_field, Some(3), None);
