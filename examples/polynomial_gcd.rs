...
fn gcd_integer_poly() {
    let mut a = MultivariatePolynomial::<_, u8>::new(2, &Z, Some(5), None);
    ...
    let mut b = MultivariatePolynomial::<_, u8>::new(2, &Z, Some(5), None);
...
fn gcd_rat_poly() {
    let mut a = MultivariatePolynomial::<_, u8>::new(3, &Q, Some(6), None);
    ...
    let mut b = MultivariatePolynomial::<_, u8>::new(3, &Q, Some(8), None);
